...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "José", "jose@outlook.com", new DateTime(1998, 4, 20), 1000.0, d1);
            Seller s2 = new Seller(1, "Eduardo", "eduardo@outlook.com", new DateTime(2001, 1, 12), 3000.0, d2);
            Seller s3 = new Seller(1, "João", "joao@outlook.com", new DateTime(1997, 7, 27), 1700.0, d3);
            Seller s4 = new Seller(1, "Lucas", "lucas@outlook.com", new DateTime(1990, 1, 10), 2000.0, d4);
            Seller s5 = new Seller(1, "Carlos", "carlos@outlook.com", new DateTime(1980, 2, 5), 2500.0, d1);
            Seller s6 = new Seller(1, "Mário", "mario@outlook.com", new DateTime(1999, 6, 13), 4000.0, d2);
